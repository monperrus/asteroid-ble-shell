...
{
    updateValue(QByteArray(1, MEDIA_COMMAND_PAUSE));
}

void MediaCommandsChrc::playRequested()
{
    updateValue(QByteArray(1, MEDIA_COMMAND_PLAY));
}
...
{
    updateValue(QByteArray(1, MEDIA_COMMAND_NEXT));
}

void MediaCommandsChrc::previousRequested()
{
    updateValue(QByteArray(1, MEDIA_COMMAND_PREVIOUS));
}
