...
/* BLE UART control interface (session bus) */
#define UART_CONTROL_SERVICE_NAME "org.asteroidos.btsyncd"
#define UART_CONTROL_PATH         "/org/asteroidos/btsyncd/uart"
#define UART_CONTROL_IFACE        "org.asteroidos.BleUart1"
